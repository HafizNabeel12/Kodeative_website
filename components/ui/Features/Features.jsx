    ...
    const features = [
        {
            ...
            title: "Live coding Classes",
            desc: "Go beyond pre-recorded videos and engage in real-time sessions alongside passionate instructors."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        },
        {
            ...
            desc: "Get matched with relevant job openings based on your skills, interests, and learning progress."
        },
        {
            icon:
            ...
            <div className="custom-screen text-gray-600 dark:text-gray-300">
                <div className="max-w-xl space-y-3">
                    <h2 className="text-gray-800 dark:text-gray-50 text-3xl font-semibold sm:text-4xl">
                        Join Kodeative and get access to all features
                    </h2>
                    <p>
                    We go beyond traditional learning platforms by offering a comprehensive suite of features designed to empower aspiring coders
                    </p>
                </div>
                <div className="mt-12">
