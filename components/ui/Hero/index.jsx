        ...
        <GradientWrapper>
            <section>
                <div className="custom-screen items-center gap-12 text-gray-600 flex flex-col sm:justify-center sm:text-center xl:flex-row xl:text-left">
                    <div className='flex-none space-y-4 max-w-4xl xl:max-w-2xl'>
                        <h1 className="text-4xl text-white font-extrabold sm:text-6xl">
                            Welcome to Kodeative Code your Dreams
                        </h1>
                        <p className="text-gray-300 max-w-xl sm:mx-auto xl:mx-0">
                            Where coding meets creativity. Turn your wildest ideas into reality with our innovative courses. We equip you with the skills to code anything you can imagine, from groundbreaking AI to stunning visuals. Unleash your inner coder and code your dreams today!
                        </p>
